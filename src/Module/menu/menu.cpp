...
#include "menu/menus/MoveMent.hpp"
#include "menu/menus/Render.hpp"
#include "menu/menus/Script.hpp"
#include "menu/menus/World.hpp"
#include <cstdlib>
#include <unwind.h>
...
const std::unordered_map<MenuType, std::function<void()>> MenuFunctions = {
    ...
    {MenuType::RENDER_MENU, drawRenderMenu}, {MenuType::MOVEMENT_MENU, drawMoveMentMenu},
    {MenuType::WORLD_MENU, drawWorldMenu}};